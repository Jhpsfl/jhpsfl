      ...
      const res = await fetch("/api/pdf/preview", {
        ...
        body: JSON.stringify({
          ...
          data: {
            ...
            discount_amount: quote.discount_type === "percent" ? quote.subtotal * (quote.discount_value || 0) / 100 : quote.discount_type === "amount" ? quote.discount_value : 0,
            discount_reason: quote.discount_reason || null,
            discount_percent: quote.discount_type === "percent" ? quote.discount_value : null,
            total: quote.total,
            notes: quote.notes,
