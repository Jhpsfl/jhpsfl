                ...
                return (
                  <div key={msg.id} className="gmail-msg-card" style={{ padding: "16px 16px 20px", background: "#0a140a", margin: "4px 8px", borderRadius: 8, border: "1px solid #1a2a1a" }}>
                    ...
                    <div style={{ marginTop: 8, overflow: "hidden" }}>
                      {hasHtml ? (
                        <iframe
                          srcDoc={`<!DOCTYPE html><html><head><meta charset="utf-8"><style>body{margin:0;padding:0;font-family:-apple-system,sans-serif;font-size:14px;line-height:1.6;color:#c8dcc8;background:#0a160a;overflow-wrap:break-word;word-break:break-word;}img{max-width:100%;height:auto;}*{max-width:100%!important;box-sizing:border-box!important;}</style></head><body>${msg.body_html}</body></html>`}
