...
export async function POST(req: NextRequest) {
  ...
  const estimateData: EstimateData = {
    ...
    discountPercent: quote.discount_type === 'percent' ? quote.discount_value : (quote.discount_type === 'amount' && quote.subtotal ? Math.round((quote.discount_value || 0) / quote.subtotal * 10000) / 100 : undefined),
