            ...
            <div style={{ borderTop: "1px solid #1a3a1a", marginTop: 8, paddingTop: 16, display: "flex", flexDirection: "column", gap: 8, alignItems: "flex-end" }}>
              ...
              {quote.discount_type && quote.discount_type !== "none" && (quote.discount_value || 0) > 0 && (
                <div style={{ display: "flex", justifyContent: "space-between", width: 220 }}>
                  ...
                  <span style={{ color: "#ef5350", fontSize: 13, fontFamily: "'JetBrains Mono', monospace" }}>-{fmt(quote.discount_type === "percent" ? quote.subtotal * (quote.discount_value || 0) / 100 : (quote.discount_value || 0))}</span>
                </div>
              )}
              {quote.tax_amount > 0 && (
                <div style={{ display: "flex", justifyContent: "space-between", width: 220 }}>
