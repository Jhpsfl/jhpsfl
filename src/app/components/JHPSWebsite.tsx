...
const FALLBACK_SERVICES = [
  { title: "Lawn Care", desc: "Mowing, edging, trimming, blowing & seasonal cleanups. Your yard, perfected every visit.", icon: "🌿", image: "https://images.unsplash.com/photo-1592417817098-8fd3d9eb14a5?w=600&h=400&fit=crop" },
  { title: "Pressure Washing", desc: "High-pressure & soft wash for driveways, buildings, sidewalks & commercial properties.", icon: "💧", image: "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&h=400&fit=crop" },
  { title: "Junk Removal", desc: "Fast, affordable haul-away for furniture, debris, appliances & construction waste.", icon: "🚛", image: "https://images.unsplash.com/photo-1530587191325-3db32d826c18?w=600&h=400&fit=crop" },
  { title: "Land Clearing", desc: "Brush removal, lot clearing & grading for residential and commercial properties.", icon: "🌲", image: "https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=600&h=400&fit=crop" },
  { title: "Property Cleanups", desc: "Vacant house cleanup, overgrown yards, plant removal & full property restoration.", icon: "🏠", image: "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=600&h=400&fit=crop" },
];
